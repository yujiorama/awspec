  ...
  stub_responses: {
    describe_alarms: {
      metric_alarms: [
        ...
        {
          alarm_name: 'my-billing-alarm',
          alarm_arn: 'arn:aws:cloudwatch:us-east-1:1234567890:alarm:my-billing-alarm',
          alarm_description: 'my-billing-alarm',
          alarm_configuration_updated_timestamp: Time.new(2015, 1, 2, 10, 00, 00, '+00:00'),
          actions_enabled: true,
          ok_actions: ['arn:aws:sns:us-east-1:1234567890:sns_billing_alert'],
          alarm_actions: ['arn:aws:sns:us-east-1:1234567890:sns_billing_alert'],
          insufficient_data_actions: ['arn:aws:sns:us-east-1:1234567890:sns_billing_alert'],
          state_value: 'OK',
          state_reason: 'Threshold Crossed: 1 datapoint (53.0) was not less than or equal to the threshold (5.0).',
          state_reason_data:
            '{\'version\':\'1.0\',\'queryDate\':\'2015-04-04T01:06:26.904+0000\',\'startDate\':\'2015-04-04T01:01:00.000+0000\',\'statistic\':\'Average\',\'period\':300,\'recentDatapoints\':[53.0],\'threshold\':5.0}',
